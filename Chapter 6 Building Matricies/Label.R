...
matplot(table, type = "b", pch=15:17, col = 2:4, xlab = "Months", ylab = "Average High (°C) ", 
        xlim = c(1,6), ylim = c(0,35), axes=FALSE, main="City Temperature Comparison")
...
axis(2)
legend("topleft", inse=0.02, pch=15:17, col=2:4, legend = colnames(table))